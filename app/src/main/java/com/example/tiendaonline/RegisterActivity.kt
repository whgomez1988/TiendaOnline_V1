...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Listener para el botón de registro con Google
        findViewById<Button>(R.id.btnGoogleSignIn).setOnClickListener {
            signInWithGoogle()
        }

        // Listener para el botón de registro con correo y contraseña
        ...
        // Listener para el botón de volver a MainActivity
